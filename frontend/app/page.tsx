...
import SiteVisitChart from "../components/dashboard/SiteVisitChart";
import MonthlySalesChart from "../components/dashboard/MonthlySalesChart";
import PropertySalesTrendChart from "../components/dashboard/PropertySalesTrendChart";
...
export default function DashboardPage() {
  ...
  // Sparkline data sequences for premium visualizations
  const sparkData = {
      ...
      <div className="space-y-6">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 space-y-4">
            ...
            <span className="text-sm font-semibold text-slate-500">Loading your real estate dashboard...</span>
          </div>
        ) : (
          <>
